import pytest
from bereikbaarheid.isochrones.isochrones import get_isochrones, _transform_results
from unittest.mock import patch, MagicMock

QUERY_RESULT = [(24379, 1158098, {
    "type": "LineString",
    "coordinates": [
        [
            120912.8359375,
...
class TestIsochrones:
    ...
    @patch("bereikbaarheid.isochrones.isochrones.django_query_db",
    ...
    def test_get_traffic_signs(self):
        ...
        """
        serialized_data = {
            "lat": 52.363066102529295,
            "lon": 4.907205867943042
        }
