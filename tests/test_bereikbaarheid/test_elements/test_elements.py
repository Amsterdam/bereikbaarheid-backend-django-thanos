...
from bereikbaarheid.elements.elements import get_elements, raw_query, _transform_results
...
QUERY_RESULT = [(
    {
        ...
        "coordinates": [
            [[4.910313956896239, 52.40562576579803]]
        ]
    }, 28234, 29, 30, "Botterstraat",
    [
        {
...
class TestElements:
    ...
    @patch("bereikbaarheid.elements.elements.django_query_db",
