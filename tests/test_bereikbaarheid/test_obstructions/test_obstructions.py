import pytest
from bereikbaarheid.obstructions.obstructions import _transform_results, raw_query, get_obstructions
...
class TestObstructions:
    ...
    @patch("bereikbaarheid.obstructions.obstructions.django_query_db",
